...
import { PlusCircle, Pencil, Trash2, MapPin, ChevronRight } from "lucide-react";
...
const DireccionPage = () => {
  ...
  const handleSubmitAddress = async (newAddress: Omit<IAddress, "id">) => {
    ...
    const payload = { ...newAddress, userId: Number(userId) };
    try {
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex flex-wrap gap-x-4 gap-y-1 mt-2 text-sm text-gray-500">
                      ...
                      {address.apartment && <span>Depto: {address.apartment}</span>}
                    </div>
                  </div>
                </div>
