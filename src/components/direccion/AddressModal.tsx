...
import { X, MapPin, Home, Navigation, Layers, Hash, Mail } from "lucide-react";
...
export const AddressModal: React.FC<Props> = ({
  ...
  const handleFormSubmit = async (data: Omit<IAddress, "id">) => {
    await onSubmit(data);
    reset();
    onClose();
  };
  ...
  return (
    ...
    >
      <div >
        <div className="rounded-xl shadow-xl p-4 max-w-md w-full mx-auto bg-white">
          <div className="flex justify-between items-center px-4 pt-4">
            <DialogHeader className="text-2xl font-bold text-gray-800 p-0">
          ...
          <DialogBody className="p-4 md:p-6">
            ...
            >
              ...
              <DialogFooter className="pt-6 pb-2 px-0">
                <button
                  type="button"
                  onClick={onClose}
